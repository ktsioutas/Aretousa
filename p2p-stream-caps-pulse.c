...
typedef struct _CustomData {
  ...
  GstElement 	    *audio_source1 ,*capsfilter1, *audio_sink1 , *visual ,*tee1 , *audio_queue11,*audio_queue12, *video_queue , *video_convert, *video_sink,
  ...
  GstCaps *alsa_caps;
  GstCaps *caps, *caps1 ,*caps2, *caps3 ;      		  /*Caps*/
...
//				  
  ...
  data.audio_sink2 = gst_element_factory_make("pulsesink", "audio_sink2");
...
//				                             QUEUE------WAVENC-----FILESINK(WRITE TO FILE)
  ...
  g_object_set (data.audio_source3 , "port",7150 ,"caps", data.caps3 , NULL);
