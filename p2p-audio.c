...
int main (int   argc,   char *argv[])
{
  ...
  const gchar *pl1 = "alsasrc buffer-time=15000 ! alsasink buffer-time=15000 -v "; 
  const gchar *pl2 = "alsasrc latency-time=2000 buffer-time=2000 ! audioconvert ! rtpL16pay ! udpsink host=83.212.101.51 port=1000 -v"; 
  const gchar *pl3 = "udpsrc port=7151 ! application/x-rtp,media=audio, clock-rate=88200, encoding-name=L16, payload=96 ! rtpL16depay ! audioconvert ! alsasink latency-time=2000  buffer-time=2000 -v";
