...
//-------ALSASRC-----------VOLUME---------AUDIOCONVERT---------ALSASINK(LISTEN YOUR SOUND)
  ...
  data.audio_source1 = gst_element_factory_make("jackaudiosrc", "audio_source1");
  ...
  data.audio_sink1 = gst_element_factory_make("jackaudiosink", "audio_sink1");
...
//-----------------------------ALSASRC--------AUDIOCONVERT STEREO TO MONO----------WAVENC---------FILESINK(WRITE TO FILE)
  ...
  data.audio_source7 = gst_element_factory_make("jackaudiosrc", "audio_source7");
...
//				  
  ...
  data.audio_source2 = gst_element_factory_make("jackaudiosrc", "audio_source2");
  ...
  data.audio_sink2 = gst_element_factory_make("jackaudiosink", "audio_sink2");
...
//				                             QUEUE------WAVENC-----FILESINK(WRITE TO FILE)
  ...
  data.audio_sink3 = gst_element_factory_make("jackaudiosink", "audio_sink3");
...
//				                             
  ...
  data.audio_sink9 = gst_element_factory_make("jackaudiosink", "audio_sink9");
...
//				                             
  ...
  data.audio_sink10 = gst_element_factory_make("jackaudiosink", "audio_sink10");
...
//				 
   ...
   data.audio_source4 = gst_element_factory_make("jackaudiosrc", "audio_source4");
  ...
  data.audio_sink4 = gst_element_factory_make("jackaudiosink", "audio_sink4");
...
//-------------------------BUILD THE PIPELINE8------START---------YOUR DIRECT SOUND----RECORDED-------------------------------
   ...
   data.audio_source8 = gst_element_factory_make("jackaudiosrc", "audio_source8");
...
//-------ALSASRC---------opusenc-----rtpopuspay-------UDPSINK(SEND TO NETWORK)
  ...
  data.audio_source5 = gst_element_factory_make("jackaudiosrc", "audio_source5");
...
//				                             QUEUE------WAVENC-----FILESINK(WRITE TO FILE)
  ...
  data.audio_sink6 = gst_element_factory_make("jackaudiosink", "audio_sink6");
...
//				                             QUEUE------WAVENC-----FILESINK(WRITE TO FILE)
  ...
  data.audio_sink11 = gst_element_factory_make("jackaudiosink", "audio_sink11");
